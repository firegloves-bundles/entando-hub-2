...
import AddBundleToBundleGroup
  from "./add-bundle-to-bundle-group/AddBundleToBundleGroup"
...
import IconUploader
  from "../../catalog-tile/modal-update-bundle-group/update-boundle-group/icon-uploader/IconUploader";
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      if (isMounted) {
        ...
        //default values
        let defaultCategoryId = res.categoryList.filter(
            cat => cat.name === "Solution Template")[0].categoryId
        const newObj = {
          name: "",
          description: "",
          descriptionImage: "",
          ...
          organisationId: userOrganisation ? userOrganisation.organisationId
              : undefined
        }
          ...
          <Grid>
            <Row>
              <Column sm={16} md={8} lg={8}>
                <IconUploader descriptionImage={newBundleGroup.descriptionImage}
                              disabled={false}
            ...
            <Row>
              ...
              <Column sm={16} md={8} lg={8}>
                <Select id="category" labelText="Categories"
                        value={newBundleGroup.categories[0]}
                        onChange={categoryChangeHandler}>{selectItems_Category}</Select>
              </Column>
              <Column sm={16} md={8} lg={8}>
                <TextInput id="documentation" labelText="Documentation Address"
                           onChange={documentationChangeHandler}/>
              </Column>
              <Column sm={16} md={8} lg={8}>
                <TextInput id="version" labelText="Version"
              ...
              <Column sm={16} md={16} lg={16}>
                <Select id="status" labelText="Status"
                        value={newBundleGroup.status}
              ...
              <Column sm={16} md={16} lg={16}>
                <TextArea id="description" labelText="Description"
                          ...
                          onChange={descriptionChangeHandler} cols={50}
                          rows={4}/>
              </Column>
              {/*
